...
const socials = [
  { icon: <Share2 size={24} />, label: "LinkedIn", href: "#", color: "hover:bg-blue-600" },
  { icon: <Globe size={24} />, label: "GitHub", href: "#", color: "hover:bg-slate-700" },
  { icon: <MessageCircle size={24} />, label: "WhatsApp", href: "#", color: "hover:bg-emerald-600" },
  { icon: <Mail size={24} />, label: "Email", href: "mailto:hello@joborungo.dev", color: "hover:bg-red-600" },
];
